...
Checks what breaks before you leave a tool. What exports and in what format, what is lost outright, and what the move costs in hours. Ends on low, conditional, or high switching cost. Ships an exit checklist.
...
```
Download the switch-cost skill from https://github.com/theAnirudhKumar/work-design/tree/main/skills/switch-cost, zip the switch-cost folder on its own, then upload it as a skill in Claude.
```
